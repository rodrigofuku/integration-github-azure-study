  ...
  <div id="app">
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui text container">
        ...
        <h2 class="ui inverted header">Rodrigo Fukugauti
          <div class="sub header">Aplicação copiada para aprendizagem do processo de integração entre GitHub e Azure</div>
        </h2>
        <h3 class="ui inverted header">Americana/SP, Brasil - 2020</h3>
